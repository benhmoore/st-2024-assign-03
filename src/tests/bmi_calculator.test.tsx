...
describe("BMI Designation Calculator", () => {
  ...
  // Testing for Cannot Calculate
  it("returns Cannot Calculate for BMI string value", () => {
    expect(getBMIDesignation("string").designation).toBe("Cannot Calculate");
  });

  it("returns Cannot Calculate for BMI NaN value", () => {
    expect(getBMIDesignation(NaN).designation).toBe("Cannot Calculate");
  });
});
